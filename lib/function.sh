...
prepare_setup() {
  ...
  define_specs "disk_path" "/mnt/images/hello.qcow2 or none"
  define_specs "disk_pool" "default,size=5,format=qcowa or none"
  define_specs "os_type" "linux"
  define_specs "os_variant" "rhel7"
  define_specs "network" "bridge=br0 or network=default"
  define_specs "graphics" "none"
  define_specs "console" "pty"
  define_specs "serial" "pty"
  define_specs "location" "ftp://ftp.jaist.ac.jp/pub/Linux/CentOS/7.2.1511/os/x86_64/"
  define_specs "initrd_inject" "/tmp/centos.ks.cfg or none"
